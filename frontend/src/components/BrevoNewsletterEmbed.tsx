      ...
      <form id="sib-form" method="POST" action="https://25054e3f.sibforms.com/serve/MUIFAPMA_SV7HpAbi1a74o3D3jkyZu3B2MVyqeT0rjUOhygxVNDI3-4IOF6QgYwWCIoE7vpVf_GfRHeQOtMejKQ3TsgCk9gY5MpDm8diGtWp15Qeo4G9v_vmOZwxa6AmqOQUhe6QQ-cx1Cv85noUHV2w-wPqB-Orpyue2juUdHmnCUcrJHLRwkm-mgRp3WGdjA6YABCjsRUf6TxR" data-type="subscription">
        ...
        <div style="padding: 8px 0;">
          <div class="sib-optin sib-form-block" data-required="true">
            ...
            style="margin-left:"
            ></span><span style="font-size:14px; text-align:left; font-family:Helvetica, sans-serif; color:#3C4858; background-color:transparent;"><p>Ich möchte den meepler.app Newsletter erhalten und akzeptiere die Datenschutzerklärung.</p><span data-required="*" style="display: inline;" class="entry__label entry__label_optin"></span></span> </label>
                </div>
              </div>
              <label class="entry__error entry__error--primary" style="font-size:16px; text-align:left; font-family:Helvetica, sans-serif; color:#661d1d; background-color:#ffeded; border-radius:3px; border-color:#ff4949;">
              </label>
...
<!-- End Brevo Form -->
  ...
  return <div ref={containerRef} className="w-full max-w-xl mx-auto" />;
}
